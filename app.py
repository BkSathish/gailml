...
def main():
  ...
  # seaborn plot
    ...
    if st.sidebar.checkbox("plot of value counts"):
        ...
        print("Accuracy in Detecting falsepositive Alarm:", in_accuracy_isf)
        print("Accuracy in Detecting falsenegative Alarm:", out_accuracy_isf)
        ...
        print("Accuracy in Detecting falsepositive Alarm :", in_accuracy_lof)
        print("Accuracy in Detecting falsenegative Alarm:", out_accuracy_lof)
